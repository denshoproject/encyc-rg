...
class Page(DocType):
    ...
    databox_creators = String(multi=True)
    ...
    databox_pov = String()
    databox_relatedevents = String()
    databox_availability = String(index='not_analyzed')
    databox_freewebversion = String(index='not_analyzed')
    ...
    databox_hasteachingaids = String(index='not_analyzed')
    databox_warnings = String()
    ...
    def dict_all(self, data=OrderedDict()):
        ...
        #self, 'authors_data'
        setval(self, data, 'databox_rgmediatype')
        setval(self, data, 'databox_title')
        setval(self, data, 'databox_creators')
        setval(self, data, 'databox_interestlevel')
        setval(self, data, 'databox_readinglevel')
        setval(self, data, 'databox_theme')
        setval(self, data, 'databox_genre')
        setval(self, data, 'databox_pov')
        setval(self, data, 'databox_relatedevents')
        setval(self, data, 'databox_availability')
        setval(self, data, 'databox_freewebversion')
        setval(self, data, 'databox_denshotopic')
        setval(self, data, 'databox_geography')
        setval(self, data, 'databox_facility')
        setval(self, data, 'databox_chronology')
        setval(self, data, 'databox_hasteachingaids')
        setval(self, data, 'databox_warnings')
        setval(self, data, 'body')
        return data
